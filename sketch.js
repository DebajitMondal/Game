...
function setup() {
 ...
 JumpButton = createSprite(windowWidth/2+700,windowHeight/2+150)
 JumpButton.addImage("Jump",JumpButtonImg)
 JumpButton.visible = false

 FireButton = createSprite(windowWidth/2+800,windowHeight/2)
 FireButton.addImage("Fire",FireButtonImg)
 FireButton.scale = 0.8
 FireButton.visible = false

 Rightarrow = createSprite(windowWidth/2-600,windowHeight/2+200)
 Rightarrow.addImage("Arrow",RightarrowImg)
 Rightarrow.visible = false

 Leftarrow = createSprite(windowWidth/2-800,windowHeight/2+200)
